...
2. Keep the top 3 projects visible. Current one and the 2 next in the pipeline. Use tags to define priority based on: complexity, ROI, tools available (I might be waiting for the delivery of a new router, for instance)
